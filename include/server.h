...
#define GDBFRONTENDLIVE_VERSION {0, 1, 0, "beta", '\0'}
#define GDBFRONTENDLIVE_VERSION_STRING "v0.1.0-beta"

#define GDBFRONTENDLIVE_GF_VERSION {0, 5, 3, "beta", '\0'}
#define GDBFRONTENDLIVE_GF_VERSION_STRING "v0.5.3-beta"
