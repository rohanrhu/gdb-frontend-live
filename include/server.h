...
#define GDBFRONTENDLIVE_VERSION {0, 0, 3, "git", '\0'}
#define GDBFRONTENDLIVE_VERSION_STRING "v0.0.3-git"

#define GDBFRONTENDLIVE_GF_VERSION {0, 1, 3, "git", '\0'}
#define GDBFRONTENDLIVE_GF_VERSION_STRING "v0.1.3-git"
